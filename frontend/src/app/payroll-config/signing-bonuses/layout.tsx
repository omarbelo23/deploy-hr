...
function SigningBonusesContent({
  children,
  create,
  edit,
  status,
...
export default function SigningBonusesLayout({
  children,
  create,
  edit,
  status,
  ...
  return (
    <Suspense fallback={<>{children}{create}{edit}{status}</>}>
      <SigningBonusesContent create={create} edit={edit} status={status}>
        {children}
      </SigningBonusesContent>
    </Suspense>
  );
}
